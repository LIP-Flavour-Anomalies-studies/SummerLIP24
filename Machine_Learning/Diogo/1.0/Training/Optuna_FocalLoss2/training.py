...
def objective(trial, epochs, train_loader, val_loader, input_size, class_wght, models, focal, study):
    ...
    n_units = [trial.suggest_int(f"n_units_l{i}", 12, 200) for i in range(n_layers)]
...
def main():
    try:
        ...
        checkpoint_dir = '/user/u/u24diogobpereira/LocalRep/Machine_Learning/Diogo/Evaluation/Optuna_FocalLoss2/' #Diogo
