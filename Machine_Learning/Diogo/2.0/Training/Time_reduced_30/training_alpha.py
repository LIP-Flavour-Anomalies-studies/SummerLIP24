...
def objective(trial, epochs, train_loader, val_loader, input_size, class_wght, models, focal, study, counter):
    ...
    tl_vector, vl_vector, idx, max_epoch = train_model(model, early_stopping, train_loader, val_loader, criterion, optimizer, counter, epochs)
...
def main():
    try:
        ...
        alpha_study.optimize(lambda trial: objective(trial, epochs, train_dataloader, val_dataloader, input_size, class_wght, alpha_models, False, alpha_study, counter), n_trials=30)
        ...
        checkpoint_file = 'alpha_model_checkpoint.pth'
